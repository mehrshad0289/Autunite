...
let chainName;
let USDTAddress;
let oldCollectionAbi;
let transporterAbi;
let oldCollectionAddress;
let transporterAddress;
let providerAddress;
let chainScanHeader;
if (chainId == 56) {
  ...
  MinterAddress = "0xf6c313A1235EAA7885EEB1232cb551A6Abf1877B";
  chainName = [bscTestnet];
  USDTAddress = "0xe4C31FC3B577e34af64Aae0D588e8bf3EEe0C01a";
  transporterAddress = '0xD7512746340c17C1A0F088006A82e3E1aD953383';
  oldCollectionAddress = '0xCf160775be66D1faF90eD1D3F95374cE39480E48';
  providerAddress = 'https://bsc-testnet.publicnode.com'
  chainScanHeader = 'testnet.bscscan.com'
}
MinterAbi = [
  {
    inputs: [
...
export function getOldCollectionAbi() {
  return oldCollectionAbi;
}
export function getTransporterAbi() {
  return transporterAbi;
}
export function getTransporterAddress() {
  return transporterAddress;
}
export function getOldCollectionAddress() {
  return oldCollectionAddress;
}
...
export function getChainScanHeader() {
  return chainScanHeader;
}
