  ...
  return (
    <>
      ...
      >
        ...
        {user.data.photoURL ? (
          <Avatar className="md:mx-4" alt="user photo" src={user.data.photoURL} style={{width: 48, height: 48}} />
        ) : (
        ...
        {!user.role || user.role.length === 0 ? (
          ...
          <>
            {user.role && user.role.includes('admin') && (
              <MenuItem  onClick={gotoAdminDashboard} role="button">
                <ListItemIcon className="min-w-40">
